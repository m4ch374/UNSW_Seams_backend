...
new_channel =  {'channel_id': 2, 'name':'Ant', 'members':[store['users']], 'messages':[{'message_id':0, 'id':1, 'string':'hi', 'time':'07:41:19'}]}
store['channels'].append(new_channel)

#TODO: fill in members and message data w some filler to do tests
...
def test_end_returns():
    assert channel_messages_v1(1, 2, 0) == ({'messages':[{'message_id':0, 'id':1, 'string':'hi', 'time':'07:41:19'}], 'start': 0, 'end': -1})