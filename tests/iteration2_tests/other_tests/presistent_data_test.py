...
def test_persistent():
    clear_v1()
    # Add user to data
    usr1 = auth_register_v2('email@gmail.com', '123456', 'joe', 'bidome')['auth_user_id']
    usr2 = auth_register_v2('another@gmail.com', '132435', 'obama', 'prism')['auth_user_id']
...
def test_inconsistent():
    clear_v1()
    # Add user to data
    auth_register_v2('email@gmail.com', '123456', 'joe', 'bidome')['auth_user_id']
