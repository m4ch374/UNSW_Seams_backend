...
def test_self_detail():
    ...
    assert response_data ==  {'user': {'u_id': 1, 'email': 'z5555555@ed.unsw.edu.au', 'name_first': 'William', 'name_last': 'Wu', 'handle_str': 'williamwu'}}
...
def test_other_detail():
    ...
    assert response.status_code == 200
    response_data = response.json()
    assert response_data ==  {'user': {'u_id': 2, 'email': 'z5555555@ed.unsw.edu.au', 'name_first': 'William', 'name_last': 'Wu', 'handle_str': 'williamwu'}}
