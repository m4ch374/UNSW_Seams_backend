...
#         resp = requests.post(ENDPOINT_CREATE_CHNL, data=data).json()
...
#             expected_output.append({'channel_id': resp['channel_id'], 'name': name})
#             requests.post(ENDPOINT_JOIN_CHNL, data={'token': get_token_2, 'channel_id': resp['channel_id']})
#         else:
#             data = generate_channel_input_json(get_token_2, name, True)
#             resp = requests.post(ENDPOINT_CREATE_CHNL, data=data)
#             expected_output.append({'channel_id': resp['channel_id'], 'name': name})
#             requests.post(ENDPOINT_JOIN_CHNL, data={'token': get_token_1, 'channel_id': resp['channel_id']})
