...
def test_1_user():
    ...
    assert users_all_v1(user['token']) == {'user 1': {'email': 'z8888888@ed.unsw.edu.au', 'password': '321321321', 'name_first': 'Russell', 'name_last': 'Wang', 'id': 1, 'handle': 'russellwang', 'channels': [], 'owner': True}}
